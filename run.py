            ...
            for f in os.listdir(subdir):
                ...
                if f.endswith(".jpg") or f.endswith(".png"):
                    try:
                        ...
                        vectorQuadOne = __get_image_features_memory(__quad_generator(1,image))
                        vectorQuadTwo = __get_image_features_memory(__quad_generator(2,image))
                        VectorQuadThree = __get_image_features_memory(__quad_generator(3,image))
                        vectorQuadFour = __get_image_features_memory(__quad_generator(4,image))
                        bow1 = histCalculator.hist(vectorQuadOne)
                        bow2 = histCalculator.hist(vectorQuadTwo)
                        bow3 = histCalculator.hist(VectorQuadThree)
                        bow4 = histCalculator.hist(vectorQuadFour)
